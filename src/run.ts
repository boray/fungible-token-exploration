...
/**
 * Code below is taken from: https://github.com/MinaFoundation/mina-fungible-token/blob/main/examples/e2e.eg.ts
 * 
 * The intention is to make further edits to demo features, but for now this shows a baseline transfer of tokens.
 */
